...
main: common.o errors.o symbol_table.o pre_assembly.o first_pass.o main.c main.h
	$(CC) -g common.o errors.o symbol_table.o pre_assembly.o first_pass.o main.c $(FLAGS) -o $@
